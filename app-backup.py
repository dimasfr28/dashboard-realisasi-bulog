...
def migrate_to_realisasi_compare_streamlit(supabase, df, kanwil_mapping, kancab_mapping):
    """
...
def migrate_to_realisasi_direct_streamlit(supabase, df, kanwil_mapping, kancab_mapping):
    """
                    ...
                    **Mode Append:**
                    ...
                    if table_name == "realisasi":
                        ...
                        total_inserted, skipped_kanwil, skipped_kancab = migrate_to_realisasi_compare_streamlit(
                            supabase, df_new, kanwil_map, kancab_mapping_full
                        )
